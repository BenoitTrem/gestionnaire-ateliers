...
<section class="min-h-screen bg-image relative">
    ...
    <div class="form-atelier-container">
        <div class="flex justify-between items-center">
            <h1 class="header-text_2">Créer un nouveau local</h1>
        ...
        <form method="POST" action="{{ route('locaux.store') }}">
            ...
            <div class="form-group">
                ...
                <input type="text" name="numeroLocal" id="numeroLocal" class="text-input" value="{{old('numeroLocal')}}" maxlength="10" minlength="1" required>
                @error('numeroLocal')
            ...
            <div class="form-group">
                ...
                <input type="number" name="capacite" id="capacite" class="text-input" value="{{ old('capacite') }}" max="200" min="1" required >
                @error('capacite')
                <p class="input-error">{{$message}}</p>
                @enderror
            </div>
            <div class="form-group">
                ...
                <label for="disponibilite" class="checkbox-container flex items-center gap-2 cursor-pointer">
                    <input type="checkbox" name="disponibilite" id="disponibilite" class="checkbox-input"
                           value="1" {{ old('disponibilite') ? 'checked' : '' }}>
            ...
            <div class="button-container">
                <button type="submit" class="button mt-5">Créer le local</button>
            </div>
        </form>
    </div>
    <p class="p-28"></p>
